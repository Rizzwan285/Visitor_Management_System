        ...
        <div className="min-h-screen flex items-center justify-center bg-slate-950 px-4">
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-2xl font-bold text-white">IIT Palakkad</h1>
                    <p className="text-slate-400 mt-1">Campus Security & Visitor Pass Management</p>
                </div>
                ...
                <div className="bg-slate-900 border border-slate-800 rounded-2xl p-8 shadow-xl">
                    ...
                    <form onSubmit={handleCredentialsLogin} className="space-y-4">
                        <div>
                            ...
                            <input
                                ...
                                placeholder="security@vms.iitpkd.ac.in"
                                className="w-full px-4 py-3 bg-slate-800 border border-slate-700 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
                                required
                            />
                        </div>
                        <div>
                    ...
                    <p className="text-xs text-slate-500 mt-6 text-center">
                        Google login: Use your @iitpkd.ac.in or @smail.iitpkd.ac.in account.
                        <br />
                        Security/Admin: Use assigned credentials.
                    </p>
                </div>
            </div>
        </div>
